						...
						<div class="wrap">
							...
							<div class="login p-5 bg-dark mx-auto mw-100">
								<form action="#" method="post">
									...
									<button name="connexion" type="submit" class="btn btn-primary submit mb-4" style="background-color:#0e5c30; border-radius:10px;">Connexion</button><a class="btn btn-primary submit mb-4" id="i" style="background:#04043b;border-radius:10px;border:2px solid #04043b; " href="inscription.php" >Inscription</a>
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav nav-mega mx-auto">
						<li class="nav-item active">
							<a class="nav-link ml-lg-0" href="index.php" style="color:#0e5c30;">Accueil
