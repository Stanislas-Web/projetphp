				...
				<div class="col-lg-4 col-md-4">
					<div class="fh5co-blog animate-box">
						...
						<div class="blog-text">
							...
							<p>
								<a href="modifierecole.php?identifiant=<?php echo $info['identifiantAdministrateur']; ?>&numero=<?php echo $this->getId(); ?>">Modifier</a> |
...
<?php	
		...
		public function Supprimer($idProduit)
		{
			...
			if(mysqli_num_rows($requete) == 1)
			{
				if($info = mysqli_fetch_array($requete))
				{
					if(mysqli_query($connexion, 'DELETE FROM ecoles WHERE idEcole = "'.$this->getId().'"'))
					{
?>
