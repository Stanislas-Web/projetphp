				...
				<div class="col-lg-4 col-md-4">
					<div class="fh5co-blog animate-box">
						...
						<div class="blog-text">
							...
							<p><?php echo $this->getPrix().'Fc'; ?></p>
							<p>
								<a href="modifierproduit.php?identifiant=<?php echo $info['identifiantAdministrateur']; ?>&numero=<?php echo $this->getId(); ?>" style="color:#158147">Modifier</a> |
								<a href="supprimerproduit.php?numero=<?php echo $this->getId(); ?>" style="color:#158147">Supprimer</a>
							</p>
						</div> 
					</div>
				</div>
