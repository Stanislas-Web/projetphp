		...
		<div class="gtco-container">
			<div class="row">
				<div class="col-md-12">
					...
					<form action="" method="post" enctype="multipart/form-data">
						<div class="row form-group">
							<div class="col-md-12">
								<label class="sr-only" for="name">Nom de l'ecole</label>
						...
						<div class="row form-group">
							<div class="col-md-12">
								<label class="sr-only" for="email">Categorie</label>
								<input type="text" id="email" class="form-control" placeholder="Categorie" name="categorie" required>
							</div>
						</div>
						<div class="row form-group">
							<div class="col-md-12">
								<label class="sr-only" for="email">Categorie</label>
								<input type="file" id="email" class="form-control"  name="photo" >
							</div>
						</div>

					
						<div class="form-group">
							<input type="submit" value="ajouter" class="btn btn-primary" name="ajouter"><br>
						</div>
				...
				if(isset($_POST['ajouter'])){
					require_once('classes/Ecole.class.php');
					$ajout = new Ecole();
					$ajout->setNOMECOLE($_POST['nom']);
					$ajout->setCATEGORIE($_POST['categorie']);
					$ajout->setNOMADMIN($_GET['nom']);
					$ajout->ajouter($ajout->getNomecole(),$ajout->getCategorie(),$ajout->getNomadmin());
					}
				?>
			...
			<div class="row row-p	b-md">
				...
				<div class="col-md-4">
					<div class="gtco-widget">
						<h3>A propos de<span class="footer-logo"> ecole na tshombo <span><span></span></h3>
