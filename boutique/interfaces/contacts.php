		...
		<div class="fh5co-menu">
			<div class="fh5co-box">
				...
				?>
						...
						<ul>
							<li><a href="interfaces/ajouternouvelle.php?identifiant=<?php echo $_GET['identifiant']; ?>">Ajouter une nouvelle</a></li>
							<li><a href="index.php?identifiant=<?php echo $_GET['identifiant']; ?>">Liste des nouvelles</a></li>
							<li><a href="interfaces/contacts.php?identifiant=<?php echo $_GET['identifiant']; ?>">Contacts</a></li>
			...
			<div class="row">
				...
				<div class="col-lg-12 col-md-12 text-center">
					...
					?>
							...
							<h6 id="fh5co-logo">Ils ont contacté <b>Nick Polisi</b></h6>
					<?php
						}
						else
						{
					?>
							<h3 id="fh5co-logo"><a href="index.php"><img src="images/a4.png" width="50px" height="50px"><span style="color:silver">Nick Polisi</span><sup></sup></a></h3>
							<h6 id="fh5co-logo">Actuellement sur le blog de <b>Nick Polisi</b></h6>
					<?php
						}
					?>
				</div>
	...
	<div class="container-fluid">
		<div class="row fh5co-post-entry">
			<?php
				if(isset($_GET['identifiant']))
				{
					$contact->Afficher($_GET['identifiant']);
				}
				else
			?>
		</div>
