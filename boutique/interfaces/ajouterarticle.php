  ...
  <!-- 
	...
	<div id="fh5co-offcanvas">
		...
		<div class="fh5co-menu">
			...
			<div class="fh5co-box">
				<h3 class="heading">Ajouter un article</h3>
				<form action="ajouterarticle.php?identifiant=<?php echo $_GET['identifiant']; ?>" method="post">
					<div class="form-group">
						<input name="nomArticle" type="text" class="form-control" placeholder="Nom"><br>
						<input name="prixArticle" type="text" class="form-control" placeholder="Prix"><br>
				...
				<?php
					if(isset($_POST['ajouter']))
					{
						...
						$article->Ajouter($article->getNom(), $article->getPrix(), $_GET['identifiant']);
					}
				?>
			</div>
		</div>
			...
			<div class="row">
				...
				<div class="col-lg-12 col-md-12 text-center">
					...
					?>
							...
							<h6 id="fh5co-logo">Les articles sur <b>Immaculé Boutique</b></h6>
					<?php
						}
						else
						{
