...
<html>
	...
	<title>face | Modifier une Société</title>
	...
	<nav class="fh5co-nav" role="navigation">
		...
		<div class="top-menu">
			<div class="container">
				<div class="row">
					<div class="col-xs-2">
						<div id="fh5co-logo"><a href="accueil.php"><img src="images/logo.png"><span></span></a></div>
					</div>
					...
					<form action="modifiersociete.php?identifiant=<?php echo $_GET['identifiant']; ?>&numero=<?php echo $_GET['numero']; ?>" method="post" enctype="multipart/form-data">
						...
						<div class="row form-group">
							<div class="col-md-12">
								...
								<textarea name="descriptionSociete" id="message" cols="30" rows="10" class="form-control" placeholder="Description de la societe"><?php
																																									$societe->setId($_GET['numero']);
						...
						<div class="row form-group">
							<div class="col-md-12">
								...
								<input name="logoSociete" type="file" id="subject" class="form-control" placeholder="Logo du societe" required >
							</div>
						</div>
