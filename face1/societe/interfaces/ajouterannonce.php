...
<html>
	...
	<title>face | Ajouter une annnonce</title>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6 animate-box">
					<h3>Ajouter une annonce pour le compte de la Société nommé <b><?php $societe->setId($_GET['numero']); $societe->Nom($societe->getId()); ?></b></h3>
					<form action="ajouterannonce.php?identifiant=<?php echo $_GET['identifiant']; ?>&numero=<?php echo $_GET['numero']; ?>" method="post" enctype="multipart/form-data">

						<div class="row form-group">
							<div class="col-md-12">
								<!-- <label for="email">Email</label> -->
								<input name="titreAnnonce" type="text" id="email" class="form-control" placeholder="Titre de l'annonce" required>
							</div>
						</div>
							...
							if(!empty($imageAnnonce))
							{
								...
								if(in_array(strtolower($image_ext),array('png','jpeg','gif','jpg'))==true)
								{
									...
									$requete = mysqli_query($connexion, 'SELECT *
																			FROM annonces
																			WHERE titreAnnonce = "'.$titreAnnonce.'"');
									if(mysqli_num_rows($requete) == 0)
									{
										if(mysqli_query($connexion, 'INSERT INTO annonces VALUES ("", "'.$titreAnnonce.'", "'.$descriptionAnnonce.'", "'.$imageAnnonce.'", NOW(), NOW(), "'.$_GET['numero'].'", "'.$_GET['identifiant'].'")'))
										{
?>
