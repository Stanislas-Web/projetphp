...
<html>
	...
	<title>face | <?php $societe->setId($_GET['numero']); $societe->Nom($societe->getId()); ?></title>
...
<div class="top-menu">
				...
				<div class="row">
					...
					<div class="col-xs-10 text-right menu-1">
						<ul>
							...
							<li><a href="listagence.php?identifiant=<?php echo $_GET['identifiant']; ?>&numero=<?php echo $_GET['numero']; ?>">Liste des agences </a></li>
							<li><a href="listeclient.php?identifiant=<?php echo $_GET['identifiant']; ?>&numero=<?php echo $_GET['numero']; ?>">Liste des clients </a></li>
	...
	<div id="fh5co-blog" class="fh5co-bg-section">
		<div class="container">
			...
			<div class="row animate-box"><?php echo 'fdfgg'?>
				<div class="col-md-8 col-md-offset-2 text-center fh5co-heading">
					<h2><?php echo $_GET['identifiant']; ?></h2>
					<p><?php $societe->setId($_GET['numero']); $societe->Nom($societe->getId()); ?></p>
				</div>
			</div>
			<div class="row row-bottom-padded-md">
				<?php
					$annonce->Afficher($_GET['numero']);
				?>
			</div>
		</div>
	</div>
