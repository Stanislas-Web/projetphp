<?php
	Class Inscriptions
	{
		...
		public function Effectuer($identifiantInscription, $motDePasseInscription, $repeterMotDePasseInscription, $idSociete)
		{
			...
			if(mysqli_num_rows($requete) == 0)
			{
				...
				{
					if(mysqli_query($connexion, 'INSERT INTO inscriptions VALUES ("", "'.$this->getIdentifiant().'", "'.$this->getMotDePasse().'", NOW(), NOW(), "'.$idSociete.'")'))
					{
?>
