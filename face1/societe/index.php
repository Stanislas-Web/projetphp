...
<html>
	...
	<header id="fh5co-header" class="fh5co-cover fh5co-cover-sm" role="banner" style="background-image:url(images/f.jpg);" data-stellar-background-ratio="0.5">
				...
				<div class="col-md-6 animate-box">
					...
					<form action="index.php" method="post">
						...
						<div class="form-group">
							<input name="connexion" type="submit" value="Connexion" class="btn btn-primary"> | <a href="interfaces/verification.php">inscription</a>
						</div>
					...
					<?php
						...
						{	
							...
							$connexion->Etablir($connexion->getIdentifiant(), $connexion->getMotDePasse());
						}
					?>
				</div>
			</div>
