...
<html>
	...
	<title>face | Annonce N°<?php echo $_GET['numero']; ?></title>
	...
	<header id="fh5co-header" class="fh5co-cover fh5co-cover-sm" role="banner" style="background-image:url(../logos/<?php $annonce->setId($_GET['numero']); $annonce->Image($annonce->getId()); ?>);" data-stellar-background-ratio="0.5">
