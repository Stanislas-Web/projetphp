				...
				<div class="col-lg-4 col-md-4">
					<div class="fh5co-blog animate-box">
						...
						<div class="blog-text">
							...
							<p>
								<a href="modifierannonce.php?identifiant=<?php echo $info['identifiantAdministrateur']; ?>&numero=<?php echo $this->getId(); ?>">Modifier</a> |
								<a href="supprimerannonce.php?numero=<?php echo $this->getId(); ?>">Supprimer</a>
							</p>
						</div> 
					</div>
				</div>
<?php
		...
		public function Afficherannonce($id)
		{
			...
			while($info = mysqli_fetch_array($requete))
			{
				...
				$this->setImage($info['imageAnnonce']);
				$this->setDateA($info['dateAnnonce']);
				$this->setTemps($info['tempsAnnonce']);
				$jour = substr($this->getDateA(), 8, 2);
				$mois = substr($this->getDateA(), 5, 2);
				$annee = substr($this->getDateA(), 0, 4);
?>
				<div class="col-lg-4 col-md-4">
					<div class="fh5co-blog animate-box">
						<img class="img-responsive" src="../../societe/logos/<?php echo $this->getImage(); ?>" alt="">
						<div class="blog-text">
							<h3><a href="annonce.php?identifiant=<?php echo $info['identifiantAdministrateur']; ?>&numero=<?php echo $this->getId(); ?>"><?php echo $this->getTitre(); ?></a></h3>
