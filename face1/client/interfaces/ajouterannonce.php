...
<html>
	...
	<title>e-Power | Ajouter une annnonce</title>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6 animate-box">
					<h3>Ajouter une annonce pour le compte du client nommé <b><?php $agence->setId($_GET['numero']); $agence->Nom($agence->getId()); ?></b></h3>
							...
							if(!empty($imageAnnonce))
							{
								...
								if(in_array(strtolower($image_ext),array('png','jpeg','gif','jpg'))==true)
								{
									...
									$requete = mysqli_query($connexion, 'SELECT *
																			FROM annonces
																			WHERE titreAnnonce = "'.$_POST['titreAnnonce'].'"');
									if(mysqli_num_rows($requete) == 0)
									{
										if(mysqli_query($connexion, 'INSERT INTO annonces VALUES ("", "'.$_POST['titreAnnonce'].'", "'.$_POST['descriptionAnnonce'].'", "'.$imageAnnonce.'", NOW(), NOW(), "'.$_GET['numero'].'", "'.$_GET['identifiant'].'")'))
										{
?>
