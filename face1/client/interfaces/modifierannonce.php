		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6 animate-box">
					<h3><b><?php $agence->setId($_GET['numero']); $agence->Nom($agence->getId()); ?></b>, Modification des informations</h3>
		...
		<div class="container">
			<div class="row row-pb-md">
				<div class="col-md-4 fh5co-widget">
					...
					<p>face est une plateforme de gestion des facturess électroniques en République Démocratique du Congo</p>
					</div>
			</div>
