								...
								<div class="information-wrapper">
									<div class="first-row form-group">
										...
										<div class="controls">
											...
											<input class="form-control" type="text" name="quartier" placeholder="Quartier">
										</div>
										<div class="controls">
											<label class="control-label">Avenue : </label>
											<input class="form-control" type="text" name="avenue" placeholder="Avenue">
										</div>
										<div class="controls">
											<label class="control-label">Numero d'adresse : </label>
											<input class="form-control" type="text" name="numero"placeholder="Numero d'adresse">
										</div>
									</div>
