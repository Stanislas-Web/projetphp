						...
						<div class="product-googles-info googles">
							<div class="men-pro-item">
								<div class="men-thumb-item">
									<a href="payment.html" ><img src="../administration/logos/<?php echo $this->getLogo(); ?>" class="img-fluid" alt=""></a>
										...
										<div class="googles single-item hvr-outline-out">
											<form action="interfaces/ajouterpannier.php?id=<?php echo $this->getId(); ?>" method="post">
												...
												<button type="submit" class="googles-cart pgoogles-cart">
													<a href="interfaces/ajouterpannier.php?id=<?php echo $this->getId(); ?>" style="color:#000"><i class="fas fa-cart-plus">  </i></a>
												</button>
...
?>
				...
				<div class="col-md-3 product-men women_two">
						<div class="product-googles-info googles">
							<div class="men-pro-item">
								<div class="men-thumb-item">
									<img src="../administration/logos/<?php echo $this->getLogo(); ?>" class="img-fluid" alt="">
