			...
			<div class="row">
				...
				<ul class="cart-inner-info">
						...
						<li class="galssescart galssescart2 cart cart box_1">
							<form action="interfaces/panier.php" method="post" class="last">
								<input type="hidden" name="cmd" value="_cart">
								<input type="hidden" name="display" value="1">
								<a href="interfaces/panier.php" style="color:#000"><button class="top_googles_cart" type="submit" name="submit" value="">
									Mon Panier
			...
			<div class="row footer-top-w3layouts">
				<div class="col-lg-3 footer-grid-w3ls">
					...
					<div class="footer-text">
						<p>C'est une application de livraison à domicile des produits alimentaires</p>
				...
				<div class="col-lg-3 footer-grid-w3ls">
					...
					<div class="contact-info">
						...
						<div class="phone">
							<h4></h4>
							<p> WhatsApp: +243 840 380 420</p>
							<p>Phone : +243 820 110 931</p>
