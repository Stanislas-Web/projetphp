...
<html>
	...
	<title>face | Modifier une annnonce</title>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6 animate-box">
					<h3><b><?php $societe->setId($_GET['numero']); $societe->Nom($societe->getId()); ?></b>, Modification de l'annonce</h3>
					<form action="modifierannonce.php?identifiant=<?php echo $_GET['identifiant']; ?>&numero=<?php echo $_GET['numero']; ?>&numannonce=<?php echo $_GET['numannonce']; ?>" method="post" enctype="multipart/form-data">

						<div class="row form-group">
							<div class="col-md-12">
								<!-- <label for="email">Email</label> -->
								<input name="titreAnnonce" type="text" id="email" class="form-control"  placeholder="Titre de l'annonce" placeholder>
							</div>
						</div>
						...
						<div class="row form-group">
							<div class="col-md-12">
								...
								<textarea name="descriptionAnnonce" id="message" cols="30" rows="10" class="form-control" placeholder="Description de l'annonce" required></textarea>
							</div>
						</div>
						...
						<div class="row form-group">
							<div class="col-md-12">
								...
								<input name="imageAnnonce" type="file" id="subject" class="form-control" placeholder="Image de l'annonce" required>
							</div>
						</div>
							...
							if(!empty($imageAnnonce))
							{
								...
								if(in_array(strtolower($image_ext),array('png','jpeg','gif','jpg'))==true)
								{
									...
									$requete = mysqli_query($connexion, 'SELECT *
																			FROM annonces
																			WHERE idAnnonce = "'.$_GET['numannonce'].'"');
									if(mysqli_num_rows($requete) == 1)
									{
										if(mysqli_query($connexion, 'UPDATE annonces SET titreAnnonce = "'.$titreAnnonce.'", descriptionAnnonce = "'.$descriptionAnnonce.'", imageAnnonce = "'.$imageAnnonce.'" WHERE idAnnonce = "'.$_GET['numannonce'].'"'))
										{
?>
