...
<html>
	...
	<title>face | Ajouter une agence</title>
	...
	<nav class="fh5co-nav" role="navigation">
		...
		<div class="top-menu">
			<div class="container">
				<div class="row">
					<div class="col-xs-2">
						<div id="fh5co-logo"><a href="accueil.php?identifiant=<?php echo $_GET['identifiant']; ?>&numero=<?php echo $_GET['numero']; ?>"><img src="images/face.png"><span></span></a></div>
					</div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6 animate-box">
					<h3>Ajouter une agence pour le compte de la Société nommé <b><?php $societe->setId($_GET['numero']); $societe->Nom($societe->getId()); ?></b></h3>
					<form action="ajouteragence.php?identifiant=<?php echo $_GET['identifiant']; ?>&numero=<?php echo $_GET['numero']; ?>" method="post" enctype="multipart/form-data">

						<div class="row form-group">
							<div class="col-md-12">
								<!-- <label for="email">Email</label> -->
								<input name="nomAgence" type="text" id="email" class="form-control" placeholder="Nom de l'agence" required>
							</div>
						</div>
						...
						<div class="row form-group">
							<div class="col-md-12">
								<!-- <label for="email">Email</label> -->
								<input name="communeAgence" type="text" id="email" class="form-control" placeholder="Commune de l'agence" required>
							</div>	
						</div>
						...
						<div class="row form-group">
							<div class="col-md-12">
								<!-- <label for="email">Email</label> -->
								<input name="rueAgence" type="text" id="email" class="form-control" placeholder="Rue de l'agence" required>
							</div>	
						</div>
						...
						<div class="row form-group">
							<div class="col-md-12">
								<!-- <label for="email">Email</label> -->
								<input name="quartierAgence" type="text" id="email" class="form-control" placeholder="Quartier de l'agence" required>
							</div>	
						</div>
						...
						<div class="row form-group">
							<div class="col-md-12">
								<!-- <label for="email">Email</label> -->
								<input name="numeroAgence" type="text" id="email" class="form-control" placeholder="Numero de l'agence" required>
							</div>	
						</div>
					...
					if(isset($_POST['ajouter'])){
						...
						$requete = mysqli_query($connexion, 'SELECT *
																FROM agences
																WHERE nomAgence = "'.$nomAgence.'"');
						if(mysqli_num_rows($requete) == 0)
						{
							if(mysqli_query($connexion, 'INSERT INTO agences VALUES ("", "'.$nomAgence.'", "'.$communeAgence.'","'.$rueAgence.'","'.$quartierAgence.'","'.$numeroAgence.'", NOW(), NOW(),"'.$_GET['numero'].'")'))
							{
			?>
