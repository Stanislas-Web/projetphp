...
<?php
		...
		public function Verification($idClient)
		{
			...
			if(mysqli_num_rows($requete) == 1)
			{
				...
				{
?>
					<script>document.location.replace("interfaces/accueil.php?numero=<?php echo $info['idAgence']; ?>&numeroSociete=<?php echo $info['idSociete']; ?>&numeroAgence=<?php echo $info['idClient']; ?>");</script>
<?php
				}
				else
				{
