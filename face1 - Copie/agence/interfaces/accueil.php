...
<html>
	...
	<title>face | <?php $agence->setId($_GET['numeroAgence']); $agence->Nom($agence->getId()); ?></title>
					...
					<div class="col-xs-10 text-right menu-1">
						<ul>
							...
							<li class="has-dropdown">
								<a href="#">Messages</a>
								<ul class="dropdown">
									<li><a href="envoyermessage.php?numeroAgence=<?php echo $_GET['numeroAgence']; ?>&numeroSociete=<?php echo $_GET['numeroSociete']; ?>">Envoyer un message</a></li>
									<li><a href="boitedereception.php?numeroAgence=<?php echo $_GET['numeroAgence']; ?>&numeroSociete=<?php echo $_GET['numeroSociete']; ?>">Boite de réception</a></li>
								</ul>
							</li>
							<li class="has-dropdown">
		...
		<div class="container">
			...
			<div class="row row-bottom-padded-md">
				<?php
					...
					$facture->setId($_GET['numeroAgence']);
