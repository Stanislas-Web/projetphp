	...
	if($_SESSION['id']==0){
		...
		<div class="container">
			<div class="inner-sec-shop px-lg-4 px-3">
				<h3 class="tittle-w3layouts my-lg-4 mt-3" style="text-align:center;">faite Votre Commande </h3>
...
<?php
	...
	?>
				...
				<div class="checkout-left row">
					...
					<div class="col-md-8 address_form">
						<h4><?php include_once('classes/client.class.php'); $client=new Client();$client->setId($_SESSION['id']);$client->Nom($client->getId());?> Cliquez sur valider pour validez la commande</h4>
						<form action="panier1.php" method="post" class="creditly-card-form agileinfo_form">
							<section class="creditly-wrapper wrapper">
								<div class="information-wrapper">
