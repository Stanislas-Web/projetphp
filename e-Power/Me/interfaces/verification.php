...
<html>
	...
	<title>e-Power | Vérification</title>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6 animate-box">
					<h3>Insérez le matricule de votre parti, nous vérifions si vous êtes inscrits dans la plateforme</h3>
					<form action="verification.php" method="post">

						<div class="row form-group">
							<div class="col-md-12">
								<!-- <label for="email">Email</label> -->
								<input name="idParti" type="text" id="email" class="form-control" placeholder="Matricule">
							</div>
						</div>
					...
					<?php
						...
						{	
							$parti->setId($_POST['idParti']);
							$parti->Verification($parti->getId());
						}
					?>
				</div>
			</div>
