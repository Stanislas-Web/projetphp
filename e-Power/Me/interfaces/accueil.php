...
<html>
	...
	<title>e-Power | <?php echo $_GET['identifiant']; ?></title>
		...
		<div class="container">
			<div class="row animate-box">
				<div class="col-md-8 col-md-offset-2 text-center fh5co-heading">
					...
					<p><?php $parti->setId($_GET['numero']); $parti->Nom($parti->getId()); ?></p>
				</div>
			</div>
			<div class="row row-bottom-padded-md">
				<?php
					$annonce->AfficherMilitant($_GET['identifiant'], $_GET['numero']);
				?>
			</div>
		</div>
	</div>
