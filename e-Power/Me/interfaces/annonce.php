...
<html>
	...
	<title>e-Power | Annonce N°<?php echo $_GET['numero']; ?></title>
	...
	<header id="fh5co-header" class="fh5co-cover fh5co-cover-sm" role="banner" style="background-image:url(../photoProfil/<?php $inscription->setIdentifiant($_GET['identifiant']); $inscription->PhotoProfil($inscription->getIdentifiant()); ?>);" data-stellar-background-ratio="0.5">
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6 animate-box">
					...
					<form action="annonce.php?identifiant=<?php echo $_GET['identifiant']; ?>&identifiantAdministrateur=<?php echo $_GET['identifiantAdministrateur']; ?>&numero=<?php echo $_GET['numero']; ?>" method="post">

						
						<div class="row form-group">
							<div class="col-md-12">
								<!-- <label for="message">Message</label> -->
								<textarea name="contenuCommentaire" id="message" cols="30" rows="10" class="form-control" placeholder="Exprimez-vous"></textarea>
							</div>
						</div>
					...
					<?php
						...
						{	
							$commentaire->setContenu($_POST['contenuCommentaire']);
							$commentaire->Ajouter($commentaire->getContenu(), $_GET['numero'], $_GET['identifiant']);
						}
					?>
					<hr>
					Liste des commentaires<hr><br>
					<?php $commentaire->Afficher(); ?>
				</div>
			</div>
