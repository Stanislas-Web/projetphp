...
<html>
	...
	<title>e-Power | Modifier un parti</title>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6 animate-box">
					...
					<form action="modifierparti.php?identifiant=<?php echo $_GET['identifiant']; ?>&numero=<?php echo $_GET['numero']; ?>" method="post" enctype="multipart/form-data">
							...
							if(!empty($logoParti))
							{
								...
								if(in_array(strtolower($image_ext),array('png','jpeg','gif','jpg'))==true)
								{
									...
									$requete = mysqli_query($connexion, 'SELECT *
																			FROM partis
																			WHERE idParti = "'.$_GET['numero'].'"');
									if(mysqli_num_rows($requete) == 1)
									{
										if(mysqli_query($connexion, 'UPDATE partis SET nomParti = "'.$_POST['nomParti'].'", descriptionParti = "'.$_POST['descriptionParti'].'" WHERE idParti = "'.$_GET['numero'].'"'))
										{
?>
...
<?php
										...
										{
											echo 'Erreur de modification des informations du parti';
										}
									}
									else
									{
