		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6 animate-box">
					<h3>Modifier le produit<b> <?php include_once('Produits.class.php');$produit = new Produits();$produit->setId($_GET['numero']);$produit->Nom($produit->getId());  ?></h3>
					<form action="modifierproduit.php?identifiant=<?php echo $_GET['identifiant']; ?>&numero=<?php echo $_GET['numero']; ?>" method="post" enctype="multipart/form-data">
						...
						<div class="row form-group">
							<div class="col-md-12">
								...
								<input name="nomProduit" type="text" id="email" class="form-control" value="<?php
																												include_once('Produits.class.php');
																												$produit = new Produits();
																												$produit->setId($_GET['numero']); 
																												$produit->Nom($produit->getId()); 
																											?>">
							</div>
						</div>
						...
						<div class="row form-group">
							<div class="col-md-12">
								...
								<input name="categorieProduit" type="text" id="email" class="form-control" value="<?php 
																														include_once('Produits.class.php');
																														$produit = new Produits();
																														$produit->setId($_GET['numero']); 
																														$produit->Categorie($produit->getId()); 
																													?>">
							</div>
						</div>
						<div class="row form-group">
							<div class="col-md-12">
								<!-- <label for="message">Message</label> -->
								<input name="prixProduit" type="text" id="email" class="form-control" value="<?php 
																													include_once('Produits.class.php');
																													$produit = new Produits();
																													$produit->setId($_GET['numero']); 
																													$produit->Prix($produit->getId()); 
																												?>">
							</div>
						</div>
						...
						<div class="row form-group">
							<div class="col-md-12">
								...
								<input name="logoProduit" type="file" id="subject" class="form-control" value="<?php 
																													include_once('Produits.class.php');
																													$produit = new Produits();
																													$produit->setId($_GET['numero']); 
																													$produit->Logo($produit->getId()); 
																												?>" required>
							</div>
						</div>
