<?php
session_start();
include('pages_et_classes/pages/classes1.php');
include('pages_et_classes/pages/objets1.php');
...
<html>
	...
	<nav class="fh5co-nav" role="navigation">
		...
		<div class="top-menu">
			<div class="container">
				<div class="row">
					<div class="col-xs-2">
						<div id="fh5co-logo"><a href="index.php"><img src="images/lobiko.png"><span></span></a></div>
					</div>
	...
	<header id="fh5co-header" class="fh5co-cover fh5co-cover-sm" role="banner" style="background-image:url(images/ddd.jpg);" data-stellar-background-ratio="0.5">
	...
	<?php include_once('pages_et_classes\pages\footer.php');?>