	...
	<nav class="fh5co-nav" role="navigation">
		...
		<div class="top-menu">
			<div class="container">
				<div class="row">
					<div class="col-xs-2">
						<div id="fh5co-logo"><a href="accueil.php?identifiant=<?php echo $_GET['identifiant']; ?>"><img src="images/logo1.png"><span></span></a></div>
					</div>
						...
						<ul>
							<li class="has-dropdown">
								...
								<ul class="dropdown" style="background-color:">
									<li><a href="ajouterecole.php?identifiant=<?php echo $_GET['identifiant']; ?>">Ajouter Ecoles</a></li>		
								</ul>
