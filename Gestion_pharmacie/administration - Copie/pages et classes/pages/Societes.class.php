...
<?php
				...
				{
					echo 'Erreur dans l\'ajout de la societe';
				}
			}
			else
			{
				...
				<div class="col-lg-4 col-md-4">
					<div class="fh5co-blog animate-box">
						...
						<div class="blog-text">
							...
							<p>
								<a href="modifiersociete.php?identifiant=<?php echo $info['identifiantAdministrateur']; ?>&numero=<?php echo $this->getId(); ?>">Modifier</a> |
								<a href="supprimersociete.php?numero=<?php echo $this->getId(); ?>">Supprimer</a>
							</p>
						</div> 
					</div>
				</div>
<?php
		...
		public function Matricule($idSociete)
		{
			...
			if(mysqli_num_rows($requete) == 1)
			{
				...
				{
					echo 'Erreur de chargement du matricule de la societe';
				}
			}
			else
			{
		...
		public function Timing($idSociete)
		{
			...
			if(mysqli_num_rows($requete) == 1)
			{
				...
				{
					echo 'Erreur de chargement de la date d\'enregistrement de la societe';
				}
			}
			else
			{
		...
		public function Description($idSociete)
		{
			...
			if(mysqli_num_rows($requete) == 1)
			{
				...
				{
					echo 'Erreur de chargement de la description du societe';
				}
			}
			else
			{
		...
		public function Logo($idSociete)
		{
			$connexion = mysqli_connect('localhost', 'root', '') or die('error'); // Connexion au serveur
			mysqli_select_db($connexion, 'face'); // Connexion à la base de données
			$requete = mysqli_query($connexion, 'SELECT *
			...
			if(mysqli_num_rows($requete) == 1)
			{
				...
				{
					echo 'Erreur de chargement du logo de la societe';
				}
			}
			else
			{
				echo 'Logo inexistant';
			}
		}
...
<?php	
					...
					{
						echo 'Erreur dans la modification de la societe';
					}
				}
				else
				{
