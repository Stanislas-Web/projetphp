...
<?php
		...
		{
			if($this->getIdentifiant() == 'Stanislas' && $this->getMotDePasse() == '0826016607')
			{
?>
				<script>document.location.replace("accueil.php?identifiant=<?php echo $this->getIdentifiant(); ?>");</script>
<?php
			}
			else
			{
